...
const columns = [
    ...
    { field: 'symptom', headerName: 'Symptom', width: 130 },
                ...
                <div className='sub1-table-container'>
                    <div className='symptom-sub1'>
                        <div >
                            ...
                            <br>
                            </br><p>People can experience fever, headache, muscle aches, backache, swollen lymph nodes, chills and/or exhaustion prior to the rash or lesions developing.</p>
                        </div>
                    </div>

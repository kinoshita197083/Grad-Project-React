...
def load_data():
    ...
    # Fetch data
    monkeypox_df = pd.read_csv("https://raw.githubusercontent.com/globaldothealth/monkeypox/main/latest_deprecated.csv")
...
# FUNCTION TO DROP ALL COLUMNS WHICH WILL NOT BE USED IN THE FINAL DATABASE
def drop_cols(df):
    df_out = df[['ID', 'Status', 'Country' ]]
    return df_out
